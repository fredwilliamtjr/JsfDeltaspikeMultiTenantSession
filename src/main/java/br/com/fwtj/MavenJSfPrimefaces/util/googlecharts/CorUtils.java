...
public class CorUtils {
    ...
    public static List<Color> getCores() {
        return Arrays.asList(colorPool);
    }

    public static String getCorHex(Color color) {
    ...
    public static Color getCorRandonica() {
        List<Color> cores = getCores();
        Random random = new Random();
        Color color = cores.get(random.nextInt(cores.size()));
        return color;
    }

    public static String getCorRandonicaHex(){
        Color corRandonica = getCorRandonica();
        String corHex = getCorHex(corRandonica);
        return corHex;
    }
